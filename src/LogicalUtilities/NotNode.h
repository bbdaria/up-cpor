...
public:
    ...
    virtual std::shared_ptr<Formula> regress(std::shared_ptr<PlanningAction> a, const std::unordered_set<std::shared_ptr<Predicate>>& o) override { return clone(); }
    ...
    virtual void get_all_optional_predicates(std::unordered_set<std::shared_ptr<Predicate>>& p) const override {}
    ...
    virtual std::shared_ptr<Formula> remove_impossible_options(const std::unordered_set<std::shared_ptr<Predicate>>& o) override { return clone(); }
    virtual std::shared_ptr<Formula> apply_known(const std::unordered_set<std::shared_ptr<Predicate>>& k) override { return reduce(k); }
    ...
    virtual std::shared_ptr<Formula> reduce_conditions(const std::unordered_set<std::shared_ptr<Predicate>>& k) override { return reduce(k); }
